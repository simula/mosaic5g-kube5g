...
func StartHSS(OaiObj Oai, CnAllInOneMode bool) {
	// Start HSS
	startHss(OaiObj, CnAllInOneMode)
}

// StartMME is a wrapper for startMme
func StartMME(OaiObj Oai, CnAllInOneMode bool) {
	// Start Mme
	startMme(OaiObj, CnAllInOneMode)
}
